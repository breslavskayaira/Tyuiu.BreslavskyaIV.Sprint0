...
using Tyuiu.BreslavskyaIV.Sprint0.Task7.V0.Lib;

namespace Tyuiu.BreslavskyaIV.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Написать контрольную программу на С#, которая суммирует значения двух    *");
